package com.example.construction_project.aspect;
...
public class LoggingAspect {
    @Pointcut("execution(public * com.example.construction_project.controller.*.*(..))")
    public void controllerLog(){}

    @Pointcut("execution(public * com.example.construction_project.service.*.*(..))")
